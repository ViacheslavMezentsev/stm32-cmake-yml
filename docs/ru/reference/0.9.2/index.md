...
[Документация](../../index.md) → Reference 0.9.2 · [English](../../../en/reference/0.9.2/index.md)

База: `f8ef5200fc7a4a96d6f3fe9111afb8f8825474b0`. [Семантика и границы версии](semantics.md) · [Errata](../../errata/index.md) · [Тестирование](../../testing.md).

## По темам

- [Проект и версия](project.md)
- [Исходники и библиотеки](sources.md)
...
[Управляющие параметры CMake и окружения](semantics.md) не являются YAML-ключами. [Индекс для инструментов](../../../reference-index.json) связывает опции, страницы, тесты и errata.
