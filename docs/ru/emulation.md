...
Шаги 1–4 реализованы в [тестах прошивок](firmware-testing.md): 18 сборок и 24 запуска QEMU и 24 запуска Renode. [Дальнейшие группы](firmware-plan.md).
...
быть ожидания GDB; debug-порты и процессы изолируются. SYS_WRITE0 проверен на закреплённых версиях; для SYS_EXIT_EXTENDED в Renode
используется явный адаптер из тестового сценария.
