...
| **Ревизия** | 1.6 (черновик для согласования) |
...
| 4.15.2, 4.15.7–4.15.9 | Проверка секции CRC; сбой CRC — провал сборки; образ по секциям Flash | Реализовано: `4cd3404`; TC-43, TC-63, TC-64. TC-52 проверен вручную на `4cd3404`, не автоматизирован `(р.1.6)` | E006; вопросы 10.2.12, 10.2.17 |
...
| 4.10.2, 4.10.4 | Комментарий в `stm32_yml_utils.cmake` о `STM32::Semihosting`; описание FloatPrint/FloatScan | Не исправлено: комментарий утверждает, что цель определяют оба toolchain-файла; stm32-cmake её не определяет `(р.1.2)` |
