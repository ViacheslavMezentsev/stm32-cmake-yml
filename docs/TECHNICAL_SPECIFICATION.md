...
| **Ревизия** | 1.3 (черновик для согласования) |
...
| 10.2.19 | Входит ли GitLab CI в приёмку 0.9.3? Реквизиты и п. 8.5.6 называют GitLab CI, но конвейера в репозитории нет; п. 8.6.1(б) допускает проверку в GitHub или GitLab; TC-53 помечен «(предлагается)» | Открыт | Предложение: принимать 0.9.3 по GitHub Actions, конвейер GitLab CI и TC-53 перенести на следующую версию с правкой реквизитов и п. 8.5.6 `(р.1.3)` | 8.5.6, 8.6.1, TC-53 |
