...
| **Ревизия** | 1.7 (черновик для согласования) |
...
| 4.8.6–4.8.8 | External FreeRTOS: поиск без компонента семейства; обёртка CMSIS-RTOS | Реализовано: `3c6bfa3`; TC-22, TC-56, TC-58, TC-59 `(р.1.6)` | E007; вопрос 10.2.8 |
...
| QEMU / Renode | 11.0.0 (`netduino2`, `netduinoplus2`) / 1.16.1 (`f103-smoke`, `h7-smoke`, `h5-smoke`) `(р.1.6)` |

### F.2. Объём проверок

| Уровень | На `7246a2c` (0.9.2) | На ветке `claude/release-0.9.3` `(р.1.6)` |
| :--- | :--- | :--- |
| L2 | — | 40 unittests |
...
| L4 | 12 профилей × 6 пар = 72 сборки | 13 профилей F103 и 4 профиля H7/H5 × 6 пар = 102 сборки |
| L5 | 78 запусков QEMU и 78 запусков Renode (включая повреждённый ELF на каждую пару) | 84 запуска QEMU (F103) и 108 запусков Renode (F103 и H7/H5), включая повреждённый ELF на каждую пару |
