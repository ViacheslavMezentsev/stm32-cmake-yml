...
**Checks (partial coverage):** `configure.profile-replace-and-append`, `configure.unknown-profile-warning`, `configure.reconfigure-profile-lists`, `configure.reconfigure-profile-name-boundaries`. [Test manifest](../../../../tests/cases.json).
...
**Checks (partial coverage):** `configure.external-profile`, `configure.external-list-profiles`, `configure.reconfigure-external-profile-reset`. [Test manifest](../../../../tests/cases.json).
