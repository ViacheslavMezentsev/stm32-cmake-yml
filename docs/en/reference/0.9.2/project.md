...
**Checks (partial coverage):** `configure.ioc-bluepill-defaults`, `configure.yaml-over-ioc`, `configure.missing-ioc`. [Test manifest](../../../../tests/cases.json).
...
**Checks (partial coverage):** `configure.yaml-over-ioc`, `configure.bluepill`. [Test manifest](../../../../tests/cases.json).
