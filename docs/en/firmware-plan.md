...
The 125 Configure cases are not 125 firmwares: malformed YAML, reconfiguration
...
Configure is separate: the current 125 scenarios give 750 checks, including
19 expected-error scenarios and 19 multistep scenarios. They do not need to
become 125 distinct firmwares. Keeping that suite, the example above would total
**about 1374 Configure + simulator checks**, besides 360 builds and script/docs
