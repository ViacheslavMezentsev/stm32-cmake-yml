...
The 119 Configure cases are not 119 firmwares: malformed YAML, reconfiguration
...
Configure is separate: the current 119 scenarios give 714 checks, including
19 expected-error scenarios and 15 multistep scenarios. They do not need to
become 119 distinct firmwares. Keeping that suite, the example above would total
**about 1338 Configure + simulator checks**, besides 360 builds and script/docs
