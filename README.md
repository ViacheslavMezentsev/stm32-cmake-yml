...
В версиях 0.9.x не используйте `_` в именах профилей: дерево YAML преобразуется
...
[Справочник 0.9.2 с изменениями 0.9.3](docs/ru/reference/0.9.2/index.md) · [Руководство](docs/user_manual.md) ·
