...
Совместимость: справочник проверен для stm32-cmake-yml 0.9.3 (карточки 0.9.2 с отметками «Изменение в 0.9.3»); CMake 3.19+,
...
1. Найдите checkout фреймворка, подключённый проектом через include/toolchain.
   ...
   выбирает установленный код. Совпадение строки версии не доказывает наличие фикса.
